...
import { AIReceptionist } from '@/components/admin/AIReceptionist'
                ...
                <div className="container mx-auto px-6 py-32">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <p className="text-white/60 text-lg mb-8 leading-relaxed">
                            The AI Receptionist Control Panel is an enterprise tool reserved for administrators. Please sign in with an authorized account to continue.
                        </p>
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-4">
                            <div>
                                <h1 className="text-5xl md:text-8xl font-black tracking-tighter uppercase mb-4 italic italic">
                                    ALBA <span className="text-accent">Control</span>
                                </h1>
                                <p className="text-white/40 uppercase tracking-[0.4em] text-xs font-black">
                                    Manage Voice, Greetings, and Dispatch Logs
                                </p>
                            </div>
                            ...
                            <div className="flex items-center gap-4 border border-white/10 p-4 rounded-2xl bg-white/[0.02]">
                                ...
                                <div>
                                    <p className="text-[10px] font-black uppercase tracking-widest text-white/40 mb-1">Reception Protocol</p>
                                    <p className="text-[11px] font-bold text-accent uppercase tracking-tight">Active Stream Engine</p>
                                </div>
                            </div>
                        </div>
                    </div>
