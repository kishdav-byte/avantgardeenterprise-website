...
export async function POST(req: Request) {
    try {
      ...
      3. DRILL SELECTION: For the 'drills' array inside each calendar day, you MUST select from this exact list of library drills: [${allowedDrills}]. If none fit perfectly, pick the closest one.
      ...
      Return ONLY a JSON response matching the required schema exactly, with NO markdown formatting, NO backticks. Schema must include:
      {
        ...
        "training_plan": [ { "day": 1, "focus": "...", "description": "...", "drills": ["The Name Game", "Focus Wall"] } ]
      }`;
    ...
    Please generate the 30-day baseline 'training_plan' JSON array. 
