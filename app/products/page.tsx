                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                    ...
                    >
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-7">
                            ...
                            >
                                <div className="absolute inset-0 bg-accent translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                                <span className="relative z-10 group-hover:text-black">Access Protocol</span>
                                <ArrowRight size={18} className="relative z-10" />
                            </a>
                        </div>
                    </motion.div>
                    ...
                    {/* PRODUCT 5: ALBA AI RECEPTIONIST */}
                    <motion.div
                        initial={{ opacity: 0, y: 40 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                    ...
                    >
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative border border-white/10 rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 group-hover:border-accent/30 aspect-video bg-black/40 flex items-center justify-center">
                                    <div className="text-center">
                                        ...
                                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40">Reception Protocol Active</p>
                                    </div>
                                </div>
                                <div className="absolute -top-4 -right-4 bg-black border border-accent/30 px-4 py-1 text-[8px] font-black uppercase tracking-widest text-accent">
                                    VOICE WEBHOOK // ONLINE
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Content Side */}
                        <div className="order-1 lg:order-2 lg:col-span-7">
                            <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase mb-2 italic">
                                ALBA AI <br /> Receptionist
                            </h2>
                            <p className="text-accent text-[11px] font-bold uppercase tracking-[0.4em] mb-8">
                                Automated Lead Bridge Agent // Voice & Multi-Channel
                            </p>

                            <div className="space-y-6 mb-10">
                                <div className="bg-white/[0.03] border-l-2 border-accent p-6 rounded-r-2xl italic relative overflow-hidden group">
                                    <div className="absolute top-0 right-0 p-4 opacity-[0.05] pointer-events-none">
                                        <Mic size={64} />
                                    </div>
                                    <p className="text-white/70 text-lg leading-relaxed mb-4">
                                        "Stop letting leads slip through the cracks. ALBA answers calls in under a second, qualifies inquiries with dynamic context, and books appointments directly on your calendar."
                                    </p>
                                    <p className="text-white/40 text-sm leading-relaxed">
                                        A comprehensive, 24/7 conversational voice agent built using state-of-the-art AI. Includes calendar scheduling, SMS/email notifications, and an automated lead qualification dashboard.
                                    </p>
                                </div>
                            </div>
                            ...
                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                                {[
                                    { label: "Voice AI", text: "Human-Like Phone Conversations" },
                                    { label: "Auto-Booking", text: "Direct Google Calendar Scheduling" },
                                    { label: "Lead Qualification", text: "3-Question Context Filtering" },
                                    { label: "Admin Dashboard", text: "Instant Controls & Dispatch Logs" },
                                ].map((item, i) => (
                                    <li key={i} className="flex gap-4 items-start p-4 bg-white/5 border border-white/5 rounded-xl">
                                        <div className="w-1.5 h-1.5 bg-accent rounded-full mt-1.5 shrink-0" />
                                        <div>
                            ...
                            <Link href="/admin/ai-receptionist" className="relative group overflow-hidden px-10 py-5 bg-white text-black font-black uppercase tracking-widest text-xs hover:bg-accent transition-colors inline-flex items-center gap-2">
                                <div className="absolute inset-0 bg-accent translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                                <span className="relative z-10 group-hover:text-black">Launch Control Panel</span>
                                <ArrowRight size={18} className="relative z-10" />
                            </Link>
                        </div>
                    </motion.div>
